...
function WorkoutPlanListPage() {
  ...
  const handleView = (id: string) => {
    if (hasAccess('workout_plan', AccessOperationEnum.READ, AccessServiceEnum.PROJECT)) {
      router.push(`/workout-plans/view/${id}`);
    }
  };
      ...
      <Box bg="white" p={4} rounded="md" shadow="md">
        {hasAccess('workout_plan', AccessOperationEnum.CREATE, AccessServiceEnum.PROJECT) && (
          <Flex justifyContent="space-between" mb={4}>
            ...
            <NextLink href={`/workout-plans/create`} passHref legacyBehavior>
