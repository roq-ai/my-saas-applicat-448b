...
-- AddForeignKey
ALTER TABLE "workout_plan" ADD CONSTRAINT "workout_plan_personal_trainer_id_fkey" FOREIGN KEY ("personal_trainer_id") REFERENCES "user"("id") ON DELETE NO ACTION ON UPDATE NO ACTION;
